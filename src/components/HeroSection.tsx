...
const HeroSection = () => {
  return (
    <section className="relative min-h-[80vh] flex items-center overflow-hidden lg:overflow-visible">
      {/* Blush circle */}
      <div className="absolute top-[50%] -translate-y-1/2 left-[55%] -translate-x-1/2 w-[400px] h-[400px] md:w-[600px] md:h-[600px] lg:left-[calc(65%-400px)] lg:translate-x-0 lg:w-[800px] lg:h-[800px] rounded-full bg-blush opacity-20" />
      ...
      <div className="container mx-auto px-6 lg:px-16 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center pt-24 lg:pt-0">
          <motion.div
            ...
            <h2 className="font-display text-2xl sm:text-4xl leading-[0.95] tracking-tight text-foreground mt-2 my-0 py-0 lg:text-3xl font-semibold">
              Measurable impact.
            </h2>
